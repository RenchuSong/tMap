...
//	}
	...
	public function actionWifiLocating() {
		if (!Rays::isPost()) {
			...
			$receiveWifiList = array();
			foreach ($wifiData as $wifiItem) {
				array_push($receiveWifiList, $wifiItem->bssid);
			}
			...
			foreach ($roomList as $room) {
				...
				var_dump($roomApList->apList);
				//echo json_encode(array_intersect($receiveWifiList, $roomApList->apList));
			}
